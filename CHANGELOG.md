...
- [#15](https://github.com/ravid7000/skills/pull/15) [`cf9269d`](https://github.com/ravid7000/skills/commit/cf9269d89073c4dad694e5926173305029e7c53a) Thanks [@ravid7000](https://github.com/ravid7000)! - Adds `handing-off-work` — a skill for the end of a session that leaves the work unfinished, producing a single Markdown document a fresh agent can resume from in a different session, a different harness, or someone else's hands.
